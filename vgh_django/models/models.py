...
class Notas(models.Model):
    notas_id = models.AutoField(primary_key=True)
...
class NotasDeEstudiante(models.Model):
    clase = models.OneToOneField(Clase, models.DO_NOTHING, primary_key=True)  # The composite primary key (clase_id, notas_id, estudiante_id) found, that is not supported. The first column is selected.
    notas = models.ForeignKey(Notas, models.DO_NOTHING)
    ...
    class Meta:
        ...
        unique_together = (('clase', 'notas', 'estudiante'),)
